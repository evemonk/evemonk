...
RSpec.describe "Get Corporations" do
  before { freeze_time }
        ...
        "edges" => [
          {
            "node" => {
              "id" => "123",
              "icon" => {
                "tiny" => "https://images.evetech.net/corporations/123/logo?size=32",
                "small" => "https://images.evetech.net/corporations/123/logo?size=64",
                "medium" => "https://images.evetech.net/corporations/123/logo?size=128",
                "large" => "https://images.evetech.net/corporations/123/logo?size=256"
              },
              "allianceId" => 1_111,
              "alliance" => {
                "id" => "1111"
          ...
          },
          {
            "node" => {
              "id" => "321",
              "icon" => {
                "tiny" => "https://images.evetech.net/corporations/321/logo?size=32",
                "small" => "https://images.evetech.net/corporations/321/logo?size=64",
                "medium" => "https://images.evetech.net/corporations/321/logo?size=128",
                "large" => "https://images.evetech.net/corporations/321/logo?size=256"
              },
              "allianceId" => 1_222,
              "alliance" => {
                "id" => "1222"
