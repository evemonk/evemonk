...
class CharacterNavBarComponentPreview < Lookbook::Preview
  def default
    ...
    render CharacterNavBarComponent.new(character: character, current_page: :sheet)
  end
  ...
  def with_real_character(id: "1", current_page: "sheet")
    ...
    render CharacterNavBarComponent.new(character: character, current_page: current_page)
  end
