...
describe Eve::AsteroidBeltImporter do
  describe "#import" do
    context "when fresh data available" do
      context "when asteroid_belt found" do
      ...
      context "when asteroid_belt not found" do
        let(:planet_id) { double }
        ...
        before { expect(EveOnline::ESI::UniverseAsteroidBelt).to receive(:new).and_raise(EveOnline::Exceptions::ResourceNotFound) }
    ...
    context "when no fresh data available" do
      ...
      before { expect(eve_asteroid_belt).not_to receive(:update!) }
