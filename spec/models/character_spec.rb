...
RSpec.describe Character do
  ...
  it { is_expected.to belong_to(:race).class_name("Eve::Race").optional(true) }

  it { is_expected.to belong_to(:bloodline).class_name("Eve::Bloodline").optional(true) }

  it { is_expected.to belong_to(:faction).class_name("Eve::Faction").optional(true) }

  it { is_expected.to belong_to(:alliance).class_name("Eve::Alliance").optional(true) }

  it { is_expected.to belong_to(:corporation).class_name("Eve::Corporation").optional(true) }

  it { is_expected.to belong_to(:current_ship_type).class_name("Eve::Ship").optional(true) }

  it { is_expected.to belong_to(:current_solar_system).class_name("Eve::System").optional(true) }

  it { is_expected.to belong_to(:current_station).class_name("Eve::Station").optional(true) }
