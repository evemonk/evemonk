...
RSpec.describe CharacterBlueprint, type: :model do
  ...
  it { expect(subject).to belong_to(:blueprint).class_name("Eve::Blueprint").with_foreign_key("type_id").optional(true) }
