...
module Eve
  class Alliance < ApplicationRecord
    ...
    def icon_tiny
      "#{imageproxy_url}https://images.evetech.net/alliances/#{id}/logo?size=32"
    end

    def icon_small
      "#{imageproxy_url}https://images.evetech.net/alliances/#{id}/logo?size=64"
    end

    def icon_medium
      "#{imageproxy_url}https://images.evetech.net/alliances/#{id}/logo?size=128"
    end

    def icon_large
      "#{imageproxy_url}https://images.evetech.net/alliances/#{id}/logo?size=256"
    end

    def icon_huge
      "#{imageproxy_url}https://images.evetech.net/alliances/#{id}/logo?size=512"
    end
