...
Rails.application.config.content_security_policy do |policy|
  ...
  policy.connect_src :self, :https, "https://sentry.io", "https://plausible.evemonk.com", "https://login.eveonline.com", "http://localhost:3035", "ws://localhost:3035", "ws://localhost:3000" if Rails.env.development?
