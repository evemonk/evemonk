FROM registry.docker.com/library/ruby:4.0.6-slim@sha256:901e9c09db7b5e7e19af81799a7dd743c89f9c5fc93dc0038f899e9131c80b5b AS builder
...
RUN gem update --system "4.0.19"

# skipcq: DOK-DL3028
RUN gem install bundler --version "4.0.19" --force --no-document
...
FROM registry.docker.com/library/ruby:4.0.6-slim@sha256:901e9c09db7b5e7e19af81799a7dd743c89f9c5fc93dc0038f899e9131c80b5b
