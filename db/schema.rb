...
ActiveRecord::Schema.define(version: 20170113214508) do
  ...
  create_table "agt_agent_types", force: :cascade do |t|
    t.string   "agent_type"
  ...
  create_table "agt_agents", force: :cascade do |t|
    t.integer  "agent_id"
    t.integer  "agent_type_id"
  ...
  create_table "agt_research_agents", force: :cascade do |t|
    t.integer  "agent_id"
    t.integer  "type_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "chr_races", force: :cascade do |t|
    t.text     "description"
    t.integer  "race_id"
    t.string   "race_name"
  ...
  create_table "inv_flags", force: :cascade do |t|
    t.integer  "flag_id"
    t.string   "flag_name"
    t.string   "flag_text"
    t.integer  "order_id"
  ...
  create_table "inv_names", force: :cascade do |t|
    t.integer  "item_id"
    t.string   "item_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "inv_positions", force: :cascade do |t|
    t.integer  "item_id"
    t.float    "pitch"
    t.float    "roll"
    t.float    "x"
